...
print("Loading observed correlations...")
...
# Aligning rows and columns of the predicted and observed correlations
...
print("RESULTS")
print("="*50)
print(f'Correlation (r): {sims.corr(sims_observed).round(2)}')
print(f'Correlation of absolute values: {sims.abs().corr(sims_observed.abs()).round(2)}')
print("="*50)